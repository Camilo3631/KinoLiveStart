...
// Obetenemos  los botones todas las 3 secciones 
...
const showMorePopularesButton = document.getElementById('show-more-populares');
const showLessPopularesButton = document.getElementById('show-less-populares');
const showMoreProximamenteButton = document.getElementById('show-more-proximamente');
...
showMorePopularesButton.addEventListener('click', function () {
  bannerSection.classList.add('d-none');
  popularesSection.classList.add('d-none');
  proximamenteSection.classList.add('d-none');
  categoryGridSection.classList.add('d-none');
  ...
  const moviesContainer = gridPopularessSection.querySelector('.movies-container');
  moviesContainer.innerHTML = '';

  gridPopulares.forEach(movie => {
    const movieCard = document.createElement('div');
  ...
  showLessPopularesButton.classList.remove('d-none');
});

showLessPopularesButton.addEventListener('click', function () {
  bannerSection.classList.remove('d-none');
  popularesSection.classList.remove('d-none');
  proximamenteSection.classList.remove('d-none');
  categoryGridSection.classList.add('d-none');
  ...
  showLessPopularesButton.classList.add('d-none');
});
...
const generarGridMoviesProximamente = () => {
  ...
  showMoreProximamenteButton.addEventListener('click', function () {
    bannerSection.classList.add('d-none');
    popularesSection.classList.add('d-none');
    proximamenteSection.classList.add('d-none');
    categoryGridSection.classList.add('d-none');
    ...
    const moviesContainer = gridProximamenteSection.querySelector('.movies-container');
    moviesContainer.innerHTML = '';
  
    gridProximamente.forEach(movie => {
      const movieCard = document.createElement('div');
      movieCard.classList.add('movie-card');
      movieCard.innerHTML = `
        <img src="${movie.imagen}" alt="${movie.titulo}">
  ...
  showLessProximamenteButton.addEventListener('click', function () {
    bannerSection.classList.remove('d-none');
    popularesSection.classList.remove('d-none');
    proximamenteSection.classList.remove('d-none');
    categoryGridSection.classList.add('d-none');
